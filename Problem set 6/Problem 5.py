...
# Which of the following statements is correct? You may assume that each function is tested with a list L whose elements are 
# sorted in increasing order; for simplicity, assume L is a list of positive integers.
